...
class upgrader{
	...
	public function _upgrade()
	{
		...
		if (isset($_POST['versionnotifier_update']))
		{
     		...
     		@unlink($newbie."/media/uploads/Ushahidi_Web/application/config/config.php");
     		//$this->remove_recursively($newbie."/media/uploads/Ushahidi_Web/application/config/config.php");
			//$this->remove_recursively($newbie."/application/logs");
			//this code below doesn't work ,the problem is "." directory isn't writable
			 $this->copy_recursively($newbie."/media/uploads/Ushahidi_Web",$newbie);
			//$this->ftp_recursively($newbie."/media/uploads/Ushahidi_Web",$newbie);
			$this->_process_sql($newbie."/sql/");
	...
	public function _process_sql($dir_path)
	{
		...
		foreach ( $files as $file )
		{
			...
			if ($file_ext == ".sql")
			{
				...
				$this->_import_sql("lynnfifi","asiimwe18","localhost","ushahidi",$dir_path.$file);
			}
		}
		return "";
	}
	public function _import_sql($username, $password, $host, $db_name,$file2, $table_prefix = NULL)
	{
